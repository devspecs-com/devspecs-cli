# Task evidence-lanes-domain-extractors D03 Plan

## Goal
Ship built-in security and API contract lanes before user-defined extraction
...
- [ ] Update `D03-ship-built-in-security-and-api-contract-lanes-be-result.md` or run `ds task checkpoint`.
