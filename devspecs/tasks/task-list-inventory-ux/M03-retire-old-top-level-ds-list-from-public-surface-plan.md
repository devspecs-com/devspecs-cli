# Task task-list-inventory-ux M03 Plan

## Goal
Retire old top-level ds list from public surface or replace it with task inventory guidance
...
- [ ] Update `M03-retire-old-top-level-ds-list-from-public-surface-result.md` or run `ds task checkpoint`.
