# Task brownfield-active-intent-ranking F03 Plan

## Goal
Add fixtures for brownfield recovery before artifacts exist and after current decision docs exist
...
- [ ] Update `F03-add-fixtures-for-brownfield-recovery-before-arti-result.md` or run `ds task checkpoint`.
