# Task workflow-profile-templates C01 Plan

## Goal
Define safe local profile schema for task templates gates prompts and evidence requirements
...
- [ ] Update `C01-define-safe-local-profile-schema-for-task-templa-result.md` or run `ds task checkpoint`.
