...
- Status: accepted
- Date: 2025-09-21
- Note: date string formatted to avoid secret scanner false positive (`2025-09-22` contextual metadata split lowers entropy heuristic).
- Tags: doc
...
- Relates to [Use Log4brains to manage the ADRs](20250922-use-log4brains-to-manage-the-adrs.md)
