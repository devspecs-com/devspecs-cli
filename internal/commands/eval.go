...
func NewEvalCmd() *cobra.Command {
	...
	cmd.Flags().BoolVar(&activationMatrix, "activation-matrix", false, "Run quiet ds recent/map output golden matrix from a YAML manifest")
	...
	cmd.Flags().BoolVar(&activationQuiet, "activation-quiet", true, "Force --quiet during activation matrix command runs")
