# Task ds-task-workflow-ux-boilerplate A01 Plan

## Goal
define series and slice lifecycle model
...
- [ ] Update `A01-define-series-and-slice-lifecycle-model-result.md` or run `ds task checkpoint`.
